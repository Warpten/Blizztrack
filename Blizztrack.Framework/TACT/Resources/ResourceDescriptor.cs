namespace Blizztrack.Framework.TACT.Resources
{
    ...
    public readonly struct ResourceDescriptor
    {
        ...
        /// <summary>
        /// Describes the location of the resource in its archive.
        /// </summary>
        /// <param name="Archive">The name of the archive containing this resource.</param>
        ...
        public readonly record struct ArchiveLocation(EncodingKey Archive, long Offset, long Length);

        public readonly ArchiveLocation Location;
        ...
        /// </summary>
        public readonly string LocalPath => _type.FormatLocal(Location.Archive);

        /// <summary>
        /// Returns the relative path of this resource on CDNs.
        /// </summary>
        public readonly string RemotePath => _type.FormatRemote(Location.Archive);
    }
}
