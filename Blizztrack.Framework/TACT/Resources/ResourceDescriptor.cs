namespace Blizztrack.Framework.TACT.Resources
{
    ...
    public readonly record struct ResourceDescriptor(ResourceType Type, string ArchiveName, long Offset = 0, long Length = 0)
    {
        public ResourceDescriptor(ResourceType resourceType, ReadOnlySpan<byte> archiveHash, long offset = 0, long length = 0)
            : this(resourceType, Convert.ToHexStringLower(archiveHash), offset, length)
        { }
